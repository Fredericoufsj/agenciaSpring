                ...
                <div className="container-fluid">
                    ...
                    <div className="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul className="navbar-nav  me-auto mb-2 mb-lg-0">
                            ...
                            <li className="nav-item">
                                <Link to="/Promocoes">
                                    <a className="nav-link active" aria-current="page" href="Promocoes.html">PROMOÇÕES</a>
                                </Link>
                            </li>
                            <li className="nav-item">
                                <Link to="/Contatos">
                            ...
                            <li className="nav-item">
                                <Link to="/Destinos">
                                    <a className="nav-link active" aria-current="page" href="Destinos.html">DESTINOS</a>
                                </Link>
                            </li>
                        </ul>
                    </div>
